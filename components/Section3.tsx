      ...
      <section className=" pt-20 sm:py">
        <div className="mx-auto w-full max-w-7xl px-6 sm:px-8">
          ...
          <p className="w-full max-w-[640px] text-[18px] leading-[1.62] text-gray-700 -mt-5 text-pretty">
            Every operational moment follows the same journey — from observation to understanding, intelligent decision-making and real-world action.
          </p>
        </div>

        {/* Full-width video container with overlay text */}
        <div ref={videoContainerRef} className="w-full overflow-hidden mt-12 relative">
          <h2 
