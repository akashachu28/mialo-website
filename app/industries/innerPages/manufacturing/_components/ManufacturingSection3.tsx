...
const METRICS = [
  { value: "48%", label: "Reduction in downtime" },
  { value: "34%", label: "Fewer quality defects" },
  { value: "67%", label: "Safety incidents prevented" },
  { value: "23%", label: "OEE improvement" },
];

export default function ManufacturingSection3() {
  return (
        ...
        <div className="relative overflow-hidden rounded-[18px] border border-line-2">
          ...
          <div className="relative flex flex-col gap-9 p-8 sm:p-12">
            <div className="flex flex-col gap-5">
              <Eyebrow>Manufacturing Impact</Eyebrow>
