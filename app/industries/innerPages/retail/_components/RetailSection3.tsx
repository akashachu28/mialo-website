...
const METRICS = [
  ...
  { value: "42%", label: "Reduction in stockouts" },
  { value: "28%", label: "Shrinkage reduced" },
  { value: "35%", label: "Shorter wait times" },
];

export default function RetailSection3() {
  return (
          ...
          <div className="relative flex flex-col gap-9 p-8 sm:p-12">
            <div className="flex flex-col gap-5">
              ...
              <h2 className="max-w-[520px] font-display text-[30px] font-medium leading-[1.12] tracking-[-0.025em] text-primary text-pretty sm:text-[36px]">
                Real results across every store.
              </h2>
            </div>
